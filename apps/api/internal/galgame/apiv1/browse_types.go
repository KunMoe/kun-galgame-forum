...
type listWorksInput struct {
	...
	IncludeNSFW           bool                        `query:"include_nsfw" default:"false" doc:"When true, adult works are included. Default false. A work whose content_limit has not been synced yet is included either way."`
