...
const testTraitsJSON = `[
	...
	{"id":"625","display_name":"Subject of (Sexual)","name_zh":"被动(性)","root_order":11,"is_sexual":true,"character_count":50},
	{"id":"21","display_name":"Hairstyle","name_zh":"发型","parents":[{"id":"1"}],"character_count":500},
	{"id":"20","display_name":"Kemonomimi","name_zh":"兽耳","parents":[{"id":"21"}],"is_searchable":true,"character_count":40,"aliases":["Animal Ears"]},
	{"id":"31","display_name":"Features","name_zh":"特征","parents":[{"id":"3"}],"character_count":300},
	{"id":"30","display_name":"Kemonomimi","name_zh":"兽耳","parents":[{"id":"31"}],"is_searchable":true,"character_count":90},
	{"id":"32","display_name":"Kemonomimi Headband","name_zh":"兽耳发箍","parents":[{"id":"31"}],"is_searchable":true,"character_count":95},
	{"id":"40","display_name":"Footwear","name_zh":"鞋类","parents":[{"id":"4"}],"character_count":400},
	{"id":"50","display_name":"Latex","name_zh":"乳胶","parents":[{"id":"4"}],"is_searchable":true,"character_count":30},
	{"id":"781","display_name":"Boots","name_zh":"靴子","parents":[{"id":"40"}],"is_searchable":true,"character_count":200,"description":"This character wears boots."},
	{"id":"782","display_name":"Knee-high Boots","name_zh":"及膝靴","parents":[{"id":"781"}],"is_searchable":true,"character_count":60},
	{"id":"783","display_name":"Latex Knee-high Boots","name_zh":"乳胶过膝靴","parents":[{"id":"782"},{"id":"50"}],"is_searchable":true,"character_count":5},
	{"id":"41","display_name":"Barefoot (Sexual)","name_zh":"赤足(性)","parents":[{"id":"40"}],"is_sexual":true,"is_searchable":true,"character_count":7},
